...
urlpatterns = [
    ...
    path('logout/',auth_views.LogoutView.as_view(template_name='home.html'),name='logout'),
     path('register/', recog_views.register, name='register'),
     path('mark_your_attendance', recog_views.mark_attendance ,name='mark-your-attendance'),
      path('mark_your_attendance_out', recog_views.mark_attendance_out ,name='mark-your-attendance-out'),
